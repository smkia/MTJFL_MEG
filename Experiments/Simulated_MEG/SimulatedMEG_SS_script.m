...
% "penalization" in line 34 to switch between SS-L1 and SS-L2.
...
for iter = 1 : iterNum
    ...
    for s = 1 : subNum
        ...
        save(strcat(savePath,'ST_SS_Simulation_', loss, penalization,'_Results.mat'),'ACC','performance','zeta','interpretable','lambda','A');
    end
end